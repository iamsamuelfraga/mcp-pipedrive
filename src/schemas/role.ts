...
export const AddRoleSchema = z.object({
  ...
  parent_role_id: OptionalIdSchema
    .describe('ID of the parent role'),
}).strict();
 ...
 */
export const DeleteRoleAssignmentSchema = z.object({
  id: IdSchema.describe('ID of the role'),
 ...
 */
export const GetRoleSettingsSchema = z.object({
  id: IdSchema.describe('ID of the role'),
}).strict();
 ...
 */
export const AddRoleSettingSchema = z.object({
  id: IdSchema.describe('ID of the role'),
  setting_key: z.string()
    .min(1, 'Setting key is required')
    .describe('Key of the setting'),
 ...
 */
export const UpdateRoleSettingSchema = z.object({
  id: IdSchema.describe('ID of the role'),
  setting_key: z.string()
    .min(1, 'Setting key is required')
    .describe('Key of the setting'),
 ...
 */
export const DeleteRoleSettingSchema = z.object({
  id: IdSchema.describe('ID of the role'),
  setting_key: z.string()
    .min(1, 'Setting key is required')
 ...
 */
export const ListRolePipelinesSchema = z.object({
  id: IdSchema.describe('ID of the role'),
  visible: z.boolean()
    .optional()
    .describe('Whether to fetch only visible pipelines'),
}).strict();
 ...
 */
export const UpdateRolePipelinesSchema = z.object({
  id: IdSchema.describe('ID of the role'),
  visible_pipeline_ids: z.record(z.number())
