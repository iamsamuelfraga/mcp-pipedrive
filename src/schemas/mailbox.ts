import { z } from 'zod';
import { IdSchema, PaginationSchema, BooleanLikeSchema } from './common.js';
 ...
 */
export const GetMailThreadSchema = z
  .object({
    id: IdSchema.describe('ID of the mail thread'),
  })
  .strict();
 ...
 */
export const GetMailThreadMessagesSchema = z
  .object({
    id: IdSchema.describe('ID of the mail thread'),
  })
  .strict();
 ...
 */
export const UpdateMailThreadSchema = z
  .object({
    id: IdSchema.describe('ID of the mail thread'),
    deal_id: IdSchema.optional().describe('ID of the deal this thread will be associated with'),
    lead_id: z.string().optional().describe('ID of the lead this thread will be associated with'),
    shared_flag: BooleanLikeSchema.optional().describe(
      'Whether the mail thread is shared with other users'
    ),
    read_flag: BooleanLikeSchema.optional().describe('Whether the mail thread is read'),
    archived_flag: BooleanLikeSchema.optional().describe('Whether the mail thread is archived'),
  })
  .strict();
 ...
 */
export const DeleteMailThreadSchema = z
  .object({
    id: IdSchema.describe('ID of the mail thread to delete'),
  })
  .strict();
 ...
 */
export const GetMailMessageSchema = z
  .object({
    id: IdSchema.describe('ID of the mail message'),
    include_body: BooleanLikeSchema.optional()
      .default(false)
