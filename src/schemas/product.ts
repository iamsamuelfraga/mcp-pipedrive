...
export const PriceSchema = z
  .object({
    ...
    notes: z.string().optional().describe('Notes about the price'),
  })
  .strict();
...
export const ListProductsSchema = PaginationSchema.extend({
  ...
  ids: z.array(IdSchema).optional().describe('Array of product IDs to return'),
  first_char: z
    .string()
  ...
  get_summary: BooleanLikeSchema.optional().describe('Include summary count in response'),
}).strict();
...
export const SearchProductsSchema = z
  .object({
    ...
    fields: z.string().optional().describe('Comma-separated list of fields to search in'),
...
export const GetProductSchema = z
  .object({
    id: IdSchema.describe('ID of the product to retrieve'),
  })
  .strict();
...
export const DeleteProductSchema = z
  .object({
    id: IdSchema.describe('ID of the product to delete'),
  })
  .strict();
 ...
 */
export const BulkDeleteProductsSchema = z
  .object({
    ids: z
      .string()
 ...
 */
export const GetProductDealsSchema = z
  .object({
    id: IdSchema.describe('ID of the product'),
    start: z
      .number()
      .int('Start must be an integer')
      .nonnegative('Start must be non-negative')
 ...
 */
export const GetProductFollowersSchema = z
  .object({
    id: IdSchema.describe('ID of the product'),
    start: z
      .number()
 ...
 */
export const AddProductFollowerSchema = z
  .object({
    id: IdSchema.describe('ID of the product'),
 ...
 */
export const RemoveProductFollowerSchema = z
  .object({
    id: IdSchema.describe('ID of the product'),
    follower_id: IdSchema.describe('ID of the follower relationship to remove'),
  })
  .strict();
 ...
 */
export const GetProductFilesSchema = z
  .object({
    id: IdSchema.describe('ID of the product'),
    start: z
      .number()
    ...
    limit: z
      ...
      .optional()
      .describe('Number of items to return'),
    sort: z.string().optional().describe('Field to sort by (id, update_time)'),
  })
  .strict();
 ...
 */
export const GetProductPermittedUsersSchema = z
  .object({
    id: IdSchema.describe('ID of the product'),
  })
  .strict();
