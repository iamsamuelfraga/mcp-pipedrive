 ...
 */
export const LeadIdSchema = z.string()
...
export const CreateLeadSchema = z.object({
  ...
  owner_id: OptionalIdSchema
    .describe('ID of the user who will own this lead'),
  label_ids: z.array(z.string().uuid('Label ID must be a valid UUID'))
    .optional()
    .describe('Array of label UUIDs'),
  person_id: OptionalIdSchema
    .describe('ID of the person this lead is associated with'),
  organization_id: OptionalIdSchema
    .describe('ID of the organization this lead is associated with'),
  value: LeadValueSchema
    .optional()
    .describe('Lead value with amount and currency'),
  expected_close_date: DateStringSchema
    .optional()
    .describe('Expected close date in YYYY-MM-DD format'),
  visible_to: VisibilitySchema
    .optional()
    .describe('Visibility of the lead'),
  was_seen: BooleanLikeSchema
    .optional()
    .describe('Whether the lead was seen'),
  origin_id: z.string()
    .optional()
    .describe('Origin ID for tracking'),
  channel: z.number()
    .int('Channel must be an integer')
    .optional()
    .describe('Channel ID'),
  channel_id: z.string()
    .optional()
    .describe('Channel identifier string'),
}).strict();
...
export const UpdateLeadSchema = z.object({
  id: LeadIdSchema
    .describe('UUID of the lead to update'),
  title: z.string()
  ...
  label_ids: z.array(z.string().uuid('Label ID must be a valid UUID'))
    ...
    .describe('Array of label UUIDs'),
  person_id: OptionalIdSchema
    .describe('ID of the person associated with this lead'),
  organization_id: OptionalIdSchema
    .describe('ID of the organization associated with this lead'),
  is_archived: BooleanLikeSchema
    .optional()
    .describe('Whether the lead is archived'),
  value: LeadValueSchema
    .optional()
    .describe('Lead value with amount and currency'),
  expected_close_date: DateStringSchema
...
export const GetLeadSchema = z.object({
  id: LeadIdSchema
    .describe('UUID of the lead to retrieve'),
}).strict();
...
export const DeleteLeadSchema = z.object({
  id: LeadIdSchema
    .describe('UUID of the lead to delete'),
}).strict();
...
export const SearchLeadsSchema = z.object({
  ...
  fields: z.string()
    .optional()
    .describe('Comma-separated fields to search (defaults to all)'),
  exact_match: BooleanLikeSchema
    .optional()
    .default(false)
    .describe('Whether to perform exact match search (case insensitive)'),
  person_id: OptionalIdSchema
    .describe('Filter by person ID (max 2000 leads)'),
  organization_id: OptionalIdSchema
    .describe('Filter by organization ID (max 2000 leads)'),
  include_fields: z.string()
    .optional()
    .describe('Comma-separated optional fields to include'),
  start: z.number()
