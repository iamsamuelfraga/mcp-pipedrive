...
export const CreateDealSchema = z.object({
  ...
  user_id: OptionalIdSchema
    .describe('ID of the user who will be marked as the owner of the deal'),
  person_id: OptionalIdSchema
    .describe('ID of the person this deal is associated with'),
  org_id: OptionalIdSchema
    .describe('ID of the organization this deal is associated with'),
  pipeline_id: OptionalIdSchema
    .describe('ID of the pipeline this deal will be placed in'),
  stage_id: OptionalIdSchema
    .describe('ID of the stage this deal will be placed in'),
  ...
  visible_to: VisibilitySchema
    .optional()
    .describe('Visibility of the deal'),
  add_time: z.string()
    .optional()
...
export const UpdateDealSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to update'),
  title: z.string()
  ...
  person_id: OptionalIdSchema
    .describe('ID of the person associated with this deal'),
  org_id: OptionalIdSchema
    .describe('ID of the organization associated with this deal'),
  pipeline_id: OptionalIdSchema
    .describe('ID of the pipeline'),
  stage_id: OptionalIdSchema
    .describe('ID of the stage'),
  status: z.enum(['open', 'won', 'lost'], {
    errorMap: () => ({ message: 'Status must be one of: open, won, lost' }),
  })
    .optional()
...
export const ListDealsSchema = PaginationSchema.extend({
  ...
  sort: z.string()
    .optional()
    .describe('Field to sort by (e.g., title, value, stage_id)'),
  sort_by: SortDirectionSchema
    .optional()
    .describe('Sort direction'),
  owned_by_you: BooleanLikeSchema
    .optional()
    .describe('Filter deals owned by the authorized user'),
}).strict();
...
export const MoveDealStageSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to move'),
  stage_id: IdSchema
    .describe('ID of the stage to move the deal to'),
}).strict();
...
export const GetDealSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to retrieve'),
}).strict();
...
export const DeleteDealSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to delete'),
}).strict();
...
export const SearchDealsSchema = z.object({
  ...
  fields: z.enum(['title', 'notes', 'custom_fields', 'all'], {
...
export const DuplicateDealSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to duplicate'),
}).strict();
 ...
 */
export const GetDealFollowersSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
}).strict();
 ...
 */
export const AddDealFollowerSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  user_id: IdSchema
 ...
 */
export const RemoveDealFollowerSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
 ...
 */
export const GetDealTimelineSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
}).strict();
...
export const AddDealParticipantSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  person_id: IdSchema
    .describe('ID of the person to add as a participant'),
}).strict();
 ...
 */
export const RemoveDealParticipantSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  deal_participant_id: IdSchema
    .describe('ID of the deal participant to remove'),
}).strict();
...
export const GetDealProductsSchema = PaginationSchema.extend({
  id: IdSchema
    .describe('ID of the deal'),
  include_product_data: BooleanLikeSchema
    .optional()
    .describe('Whether to include full product data'),
}).strict();
...
export const AddDealProductSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  product_id: IdSchema
    .describe('ID of the product to add'),
  item_price: z.number()
  ...
  product_variation_id: OptionalIdSchema
    .describe('ID of the product variation to use'),
  comments: z.string()
    .max(1000, 'Comments cannot exceed 1000 characters')
    .optional()
    .describe('Additional comments about the product'),
  enabled_flag: BooleanLikeSchema
    .optional()
    .default(true)
...
export const UpdateDealProductSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  product_attachment_id: IdSchema
    .describe('ID of the deal-product attachment to update'),
  item_price: z.number()
    .nonnegative('Price must be non-negative')
    .optional()
...
export const RemoveDealProductSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  product_attachment_id: IdSchema
    .describe('ID of the deal-product attachment to remove'),
}).strict();
 ...
 */
export const AttachDealFileSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
  file_path: z.string()
    .min(1, 'File path is required')
    .describe('Path to the file to attach'),
}).strict();
 ...
 */
export const GetDealsTimelineSchema = z.object({
  start_date: DateStringSchema
    .describe('The date when the first interval starts (YYYY-MM-DD)'),
  ...
  pipeline_id: OptionalIdSchema
    .describe('Filter by pipeline ID'),
  filter_id: OptionalIdSchema
    .describe('Filter by filter ID'),
  exclude_deals: BooleanLikeSchema
    .optional()
    .describe('Whether to exclude deals list (only return summary)'),
  totals_convert_currency: z.string()
    .optional()
...
export const ListDealActivitiesSchema = PaginationSchema.extend({
  ...
  exclude: z.string()
    .optional()
    .describe('Comma-separated activity IDs to exclude'),
}).strict();
 ...
 */
export const MergeDealsSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to merge (will be deleted)'),
  merge_with_id: IdSchema
    .describe('ID of the deal to merge with (will be kept)'),
}).strict();
 ...
 */
export const ListDealPermittedUsersSchema = z.object({
  id: IdSchema
    .describe('ID of the deal'),
}).strict();
 ...
 */
export const MarkDealAsWonSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to mark as won'),
}).strict();
 ...
 */
export const MarkDealAsLostSchema = z.object({
  id: IdSchema
    .describe('ID of the deal to mark as lost'),
  lost_reason: z.string()
    .max(255, 'Lost reason cannot exceed 255 characters')
    .optional()
    .describe('Reason why the deal was lost'),
 ...
 */
export const BulkEditDealsSchema = z.object({
  ...
  status: z.enum(['open', 'won', 'lost'], {
    ...
    .describe('Deal status'),
  user_id: OptionalIdSchema
    .describe('ID of the user who will be the owner'),
  visible_to: VisibilitySchema
    .optional()
    .describe('Visibility of the deals'),
}).strict();
