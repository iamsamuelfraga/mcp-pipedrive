...
export const GetPipelineSchema = z.object({
  id: IdSchema
    .describe('ID of the pipeline to retrieve'),
...
export const UpdatePipelineSchema = z.object({
  id: IdSchema
    .describe('ID of the pipeline to update'),
  name: z.string()
...
export const CreateStageSchema = z.object({
  ...
  pipeline_id: IdSchema
    .describe('ID of the pipeline this stage belongs to'),
  order_nr: z.number()
    .int('Order must be an integer')
    .nonnegative('Order must be non-negative')
    .optional()
  ...
  rotten_flag: z.boolean()
    .optional()
    .describe('Whether to enable rotten deals in this stage'),
  rotten_days: z.number()
...
export const UpdateStageSchema = z.object({
  id: IdSchema
    .describe('ID of the stage to update'),
  name: z.string()
  ...
  pipeline_id: OptionalIdSchema
    .describe('ID of the pipeline (to move stage to different pipeline)'),
}).strict();
...
export const DeleteStageSchema = z.object({
  id: IdSchema
    .describe('ID of the stage to delete'),
}).strict();
...
export const GetStageSchema = z.object({
  id: IdSchema
    .describe('ID of the stage to retrieve'),
}).strict();
 ...
 */
export const GetAllStagesSchema = z.object({
  pipeline_id: OptionalIdSchema
    .describe('Filter stages by pipeline ID (optional, if omitted returns all stages)'),
}).strict();
 ...
 */
export const DeleteMultipleStagesSchema = z.object({
  ids: z.string()
 ...
 */
export const GetPipelineConversionStatisticsSchema = z.object({
  id: IdSchema
    .describe('ID of the pipeline'),
  start_date: z.string()
...
export type GetPipelineConversionStatisticsInput = z.infer<typeof GetPipelineConversionStatisticsSchema>;

/**
 * Schema for getting pipeline movement statistics
 */
export const GetPipelineMovementStatisticsSchema = z.object({
  id: IdSchema
    .describe('ID of the pipeline'),
  start_date: z.string()
    .regex(/^\d{4}-\d{2}-\d{2}$/, 'Date must be in YYYY-MM-DD format')
...
export type GetPipelineMovementStatisticsInput = z.infer<typeof GetPipelineMovementStatisticsSchema>;

/**
 * Schema for getting deals in a pipeline
 */
export const GetPipelineDealsSchema = z.object({
  id: IdSchema
    .describe('ID of the pipeline'),
  filter_id: z.number()
