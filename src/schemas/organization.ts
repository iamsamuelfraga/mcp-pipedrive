...
export const CreateOrganizationSchema = z.object({
  ...
  visible_to: VisibilitySchema
    .optional()
    .describe('Visibility of the organization'),
  add_time: z.string()
    .optional()
    .describe('Creation time in ISO 8601 format'),
  label: OptionalIdSchema
    .describe('ID of the label to assign to the organization'),
  address: z.string()
...
export const ListOrganizationsSchema = PaginationSchema.extend({
  ...
  sort: z.string()
    .optional()
    .describe('Field to sort by (e.g., name, address, owner_id)'),
...
export const SearchOrganizationsSchema = z.object({
  ...
  fields: z.enum(['name', 'address', 'notes', 'custom_fields', 'all'], {
    errorMap: () => ({ message: 'Fields must be one of: name, address, notes, custom_fields, all' }),
  })
    .optional()
    .default('all')
...
export const GetOrganizationSchema = z.object({
  id: IdSchema
    .describe('ID of the organization to retrieve'),
}).strict();
...
export const DeleteOrganizationSchema = z.object({
  id: IdSchema
    .describe('ID of the organization to delete'),
}).strict();
...
export const MergeOrganizationsSchema = z.object({
  id: IdSchema
    .describe('ID of the organization to keep'),
  merge_with_id: IdSchema
    .describe('ID of the organization to merge into the first one'),
}).strict().refine(
 ...
 */
export const GetOrganizationDealsSchema = z.object({
  id: IdSchema
 ...
 */
export const GetOrganizationPersonsSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  start: z.number()
    .int('Start must be an integer')
 ...
 */
export const GetOrganizationFollowersSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
}).strict();
 ...
 */
export const AddOrganizationFollowerSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  user_id: IdSchema
 ...
 */
export const RemoveOrganizationFollowerSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
 ...
 */
export const GetOrganizationActivitiesSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  start: z.number()
    .int('Start must be an integer')
 ...
 */
export const GetOrganizationFilesSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  start: z.number()
    .int('Start must be an integer')
 ...
 */
export const GetOrganizationMailMessagesSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  start: z.number()
    .int('Start must be an integer')
 ...
 */
export const GetOrganizationChangelogSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  cursor: z.string()
    .optional()
 ...
 */
export const GetOrganizationFlowSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
  start: z.number()
    .int('Start must be an integer')
  ...
  items: z.string()
    .optional()
    .describe('Types of items to include in the flow'),
}).strict();
 ...
 */
export const GetOrganizationPermittedUsersSchema = z.object({
  id: IdSchema
    .describe('ID of the organization'),
}).strict();

export type GetOrganizationPermittedUsersInput = z.infer<typeof GetOrganizationPermittedUsersSchema>;
 ...
 */
export const GetOrganizationsCollectionSchema = z.object({
  cursor: z.string()
    .optional()
    .describe('Cursor for pagination'),
  limit: z.number()
