...
export const AddUserSchema = z
  .object({
    ...
    email: z.string().email('Invalid email format').describe('Email address of the user'),
    active_flag: BooleanLikeSchema.optional().default(true).describe('Whether the user is active'),
  })
  .strict();
...
export const UpdateUserSchema = z
  .object({
    ...
    active_flag: BooleanLikeSchema.optional().describe('Whether the user is active'),
  })
  .strict();
 ...
 */
export const ListUserFollowersSchema = z
  .object({
 ...
 */
export const AddUserFollowerSchema = z
  .object({
    id: IdSchema.describe('ID of the user'),
 ...
 */
export const DeleteUserFollowerSchema = z
  .object({
    id: IdSchema.describe('ID of the user'),
 ...
 */
export const GetUserPermissionsSchema = z
  .object({
    id: IdSchema.describe('ID of the user'),
  })
  .strict();
 ...
 */
export const ListUserRoleSettingsSchema = z
  .object({
    id: IdSchema.describe('ID of the user'),
  })
  .strict();
...
export const FindUsersSchema = z
  .object({
    ...
    search_by_email: BooleanLikeSchema.optional().describe(
      'Whether to search by email address instead of name'
    ),
  })
  .strict();
