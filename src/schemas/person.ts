...
export const ListPersonsSchema = PaginationSchema.extend({
  ...
  sort: z.string().optional().describe('Field to sort by (e.g., name, email, org_id)'),
 ...
 */
export const SearchPersonsSchema = z
  .object({
    term: z
      .string()
 ...
 */
export const GetPersonSchema = z
  .object({
    id: IdSchema.describe('ID of the person to retrieve'),
  })
  .strict();
...
export const DeletePersonSchema = z
  .object({
    id: IdSchema.describe('ID of the person to delete'),
  })
  .strict();
 ...
 */
export const MergePersonsSchema = z
  .object({
    id: IdSchema.describe('ID of the person to keep'),
    merge_with_id: IdSchema.describe('ID of the person to merge into the first one'),
  })
  .strict()
 ...
 */
export const GetPersonDealsSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    start: z
      .number()
      .int('Start must be an integer')
      .nonnegative('Start must be non-negative')
 ...
 */
export const GetPersonFollowersSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
  })
  .strict();
 ...
 */
export const AddPersonFollowerSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
 ...
 */
export const RemovePersonFollowerSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
 ...
 */
export const GetPersonActivitiesSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    start: z
      .number()
 ...
 */
export const GetPersonFilesSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    start: z
      .number()
 ...
 */
export const GetPersonMailMessagesSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    start: z
      .number()
 ...
 */
export const GetPersonProductsSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    start: z
      .number()
 ...
 */
export const GetPersonChangelogSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
 ...
 */
export const GetPersonFlowSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    start: z
      .number()
    ...
    items: z.string().optional().describe('Types of items to include'),
  })
  .strict();
 ...
 */
export const GetPersonPermittedUsersSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
  })
  .strict();
 ...
 */
export const DeletePersonPictureSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
  })
  .strict();
 ...
 */
export const AddPersonPictureSchema = z
  .object({
    id: IdSchema.describe('ID of the person'),
    file: z.instanceof(Buffer).describe('Image file buffer'),
    filename: z.string().min(1, 'Filename is required').describe('Name of the file'),
    crop_x: z
      .number()
 ...
 */
export const BulkDeletePersonsSchema = z
  .object({
    ids: z
      .string()
 ...
 */
export const GetPersonsCollectionSchema = z
  .object({
    cursor: z.string().optional().describe('Cursor for pagination'),
    limit: z
      .number()
