...
export const GetTeamSchema = z
  .object({
    id: IdSchema.describe('ID of the team'),
    skip_users: BooleanLikeSchema.optional()
      .default(false)
...
export const CreateTeamSchema = z
  .object({
    name: z
      ...
      .describe('Team name'),
    manager_id: IdSchema.describe('ID of the user who will be the manager of this team'),
    description: z
      .string()
...
export const UpdateTeamSchema = z
  .object({
    id: IdSchema.describe('ID of the team to update'),
    name: z
      .string()
      ...
      .optional()
      .describe('Team name'),
    manager_id: IdSchema.optional().describe('ID of the user who will be the manager of this team'),
    description: z
      .string()
      .max(500, 'Description cannot exceed 500 characters')
      .optional()
 ...
 */
export const GetTeamUsersSchema = z
  .object({
    id: IdSchema.describe('ID of the team'),
  })
  .strict();
...
export const AddUserToTeamSchema = z
  .object({
    id: IdSchema.describe('ID of the team'),
    user_id: IdSchema.describe('ID of the user to add to the team'),
  })
  .strict();
 ...
 */
export const DeleteUserFromTeamSchema = z
  .object({
    id: IdSchema.describe('ID of the team'),
    user_id: IdSchema.describe('ID of the user to remove from the team'),
  })
  .strict();
 ...
 */
export const GetUserTeamsSchema = z
  .object({
